...
METRIC_OPTIONS=--variables ${VAR} --spatial_agg weighted_mean --rolling_sum_window 5 --shapefile ${SHAPEFILE} --time_freq A-AUG --time_agg max --time_agg_min_tsteps 364 --input_freq D --units_timing middle --reset_times --verbose --time_agg_dates --units pr='mm day-1'
